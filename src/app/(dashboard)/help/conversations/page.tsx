  ...
  return (
    <div className="space-y-10">
      ...
      <Section title="Supported channels">
        <List>
          <li><strong>Telegram Bot</strong> — text, voice notes, photos, documents, location, stickers</li>
      ...
      <Section title="Media messages">
        <P>
          Audio, images, and documents are no longer silently dropped. The platform fetches the
          media from the provider (before expiry), then processes it:
        </P>
        <List>
          <li><strong>Voice / Audio</strong> → transcribed via Whisper using your OpenAI key</li>
        ...
        <Callout>
          Voice and image processing requires an <strong>OpenAI connector</strong> connected to
          your workspace. Without one, the agent receives a marker like{" "}
          <C>[voice message — transcription unavailable]</C> and is instructed to ask the sender
